...
export const FILE_SUFFIXES = {
  ...
  presentation_script: "_presentation_script.json", // 演讲脚本 — OpenClaw writes, PresentationEngine.runScript() consumes
...
export interface MeetingSession {
  ...
  files: {
    ...
    presentation_script?: string; // presentation script (v1 spec)
    live?: string;
    summary?: string;
    transcript?: string;
  };
