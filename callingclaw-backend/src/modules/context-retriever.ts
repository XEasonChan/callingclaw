    ...
    try {
      ...
      if (!analysis.shifted) {
        ...
        if (hadQuestion && this._topicCache.has(this._currentTopic)) {
          ...
          // HEAD moved cache matching to the module-level searchCache() (see :177,
          // comment :1345); PR #37's this.searchCache() no longer exists. lastUserText
          // is already bound at the top of this try-block, so reuse it.
